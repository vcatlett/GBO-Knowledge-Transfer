...
from astrid.gui.editor.AutoCompleter import AutoCompleter
from astrid.gui.editor.PyLexer import PyLexer
from astrid.gui.static import get_path_static


class PyEditorWidget(QsciScintilla):

    def __init__(self, parent=None, path=Path("."), is_python_file=True):
        super(PyEditorWidget, self).__init__(parent)
