...
from astrid.gui.editor.PyEditor import PyEditor
...
class FileManager(QTreeView):
    ...
    def rename_file_with_index(self):
        ...
        for editor in self.tab_view.findChildren(PyEditor):  # finding all children of type Editor
    ...
    def action_delete(self, ix):
        ...
        dialog = self.show_dialog("Delete", f"Are you sure you want to delete {file_name}")
